...
const Hero = () => {
  return (
    ...
    <div>
       ...
       <h1 className='font-[700px] text-[40px] md:text-[36px] sm:text-[36px] lg:text-[36px] xl:text-[36px] text-[#000000] leading-[65.0px]
    ...
    <div className='w-[100%] sm:w-[100%] md:w-[100%] lg:w-[100%] xl:w-[100%] h-[200px] pt-[22px]' >
        ...
        font-[500] font-[rye] leading-[43.35px] tracking-[2.5%] text-[#787054]'>
            An example of intricate workmanship and detail, elegant neckaces and long and short chains form a part of ourdesirable collection.

        </p>
    </div> 
    <div className='w-[288px] sm:w-[288px] md:w-[288px] lg:w-[288px] xl:w-[288px] h-[58px] ml-[178px] mt-[40px]
    font-[Rye] font-[500px] text-[22px] text-[white] leading-[37.35px] rounded-[1opx] gap-[10px] p-[10px] bg-[#A29875] '>
